...
\emph{Security through obscurity} is a principal within security engineering. It refers to the reliance on secrecy of the design or implementation of a system to provide security. Kerckhoffs's principle dictates that a cryptographic system where the only private information is the key should be secure.
\begin{quote}
...
%%%%%INDSÆT FIGUR OM SAML ASSERTION%%%%
\par
...
%%%%%INDSÆT FIGUR OM SAML AUTHNREQUEST%%%%
\par
...
%INDSÆT SAML ASSERTION OG MESSAGES FRA JACOB%%%

\chapter{Source code examples by Jacob H{\o}jgaard}
%INDSÆT JACOBS APPENDIX B%
\end{document}